...
public class ImageManipulation {
    ...
    public static void main(String[] args) throws Exception {
        File infile = new File("K:/jpg/test/410725200409195471.JPG");
        File outfile = new File("K:/jpg2/300.jpg");
...
//      BufferedImage output = ImageIO.read(outfile);
        ...
        jpegEncodeParam.setXDensity(120);
        jpegEncodeParam.setYDensity(160);
      ...
      public static BufferedImage toBufferedImage(Image image, int type) {
            ...
            g.drawImage(image, 120, 160, null);
            g.dispose();
            return result;
        }
}